...
export GKE_CLUSTER_NAME=${GKE_CLUSTER_NAME:-cluster-sandbox}
...
export GKE_CLUSTER_MINIMUM_NUMBER_NODES=${GKE_CLUSTER_MINIMUM_NUMBER_NODES:-1}
export GKE_CLUSTER_MAXIMUM_NUMBER_NODES=${GKE_CLUSTER_MAXIMUM_NUMBER_NODES:-3}
